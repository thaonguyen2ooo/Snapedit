...
public class DoodleController {
    ...
    public void start(Stage primaryStage) {
        ...
        for (ToggleButton tool : toolsArr) {
            ...
            tool.setStyle("-fx-background-color: black; -fx-border-radius: 15; -fx-background-radius: 15; -fx-font-size: 13px; -fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 13px; -fx-font-family: 'Monospace';");
        }
        ...
        btns.setStyle("-fx-background-color: #66cccc");
        ...
        /*------- Undo & Redo ------ for line,rectangle,ellipse,circle*/
        // Undo
        undo.setOnAction(e->{
        ...
        save.setOnAction((e) -> {
            ...
            if (file != null) {
                try {
                    ...
                    // Create a new PixelReader from the WritableImage
